...
class CategoriaDePuntajeTestCase {
	...
	private SitioWeb sitio; private	Administrador admin;
	public Propietario propietario ; public Inquilino inquilino ;
	...
	void setUp() throws Exception {
			...
			categoriaDePuntajeParaPropietario = new CategoriaDePuntaje("despacha a tiempo");
			 ...
			 sitio.setAdministrador(admin);	 admin.setSitioAcargo(sitio);
